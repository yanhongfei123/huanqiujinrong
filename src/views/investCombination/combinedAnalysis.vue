    ...
    <div class="content clear">
      ...
      <div class="legent fl">
        <div class="item" v-for="(val,index) in list" :key="index">
          <span :style="{borderColor:val.color}" class="circle"></span>
...
var list = ['China', 'United States', 'Brazil', 'Australia']
dataList.map(item=>{;
    ...
    initMap() {
      ...
      var option = {
        ...
        visualMap: {
          ...
          realtime: false,
          calculable: false,
          color: ["#FF7800",'#0EA1D4', '#FAC942','#3FC529',"#E0E0E0"],// color属性中的顺序是由数值 大 到 小
          // inRange: {
          //   color: ['#E0E0E0', '#FF7800'],
          //  // symbolSize: [0, 100]
          //}
