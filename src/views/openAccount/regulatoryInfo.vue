                ...
                <el-form title="合规信息" class="regulatoryInfoForm" :label-position="labelPosition" label-width="80px"
                    ...
                    <el-row>
                        ...
                        <el-col style="width: 380px;margin-left: 20px;">
                            <el-form-item label="净流动资产:" prop="netCurrentAsset" required>
                                <el-select v-model="regulatoryInfo.netCurrentAsset" placeholder="请选择净流动资产"
                                           style="width: 100%;">
                                    <el-option
                                            v-for="(item,key) in netCurrentAsset"
                                            :key="key"
                                            :label="item"
                                            :value="key">
                                    </el-option>
                        ...
                        <el-col style="width: 380px">
                            <el-form-item label="净年收入:" prop="netAssetYear" required>
                                <el-select v-model="regulatoryInfo.netAssetYear" placeholder="请选择净年收入"
                                           style="width: 100%;">
                                    <el-option
                                            v-for="(item,key) in netAnnualIncome"
                                            :key="key"
                                            :label="item"
                                            :value="key">
                                    </el-option>
                    ...
                    <el-form-item
                        ...
                        <el-checkbox-group class="invest-checkbox" v-model="regulatoryInfo.investTargetArr"
                            ...
                            <el-checkbox :label="item" :key="key" v-for="(item, key) in investTarget"></el-checkbox>
                        </el-checkbox-group>
                    </el-form-item>
                    ...
                    <el-form-item
                                ...
                                <el-form-item prop="stockExperiencesTimes" class="margin-bottom-30">
                                    <el-select v-model="regulatoryInfo.stockExperiencesTimes" placeholder="请选择每年交易次数">
                                        <el-option :label="item" :value="key" :key="key"
                                                   v-for="(item, key) in tradeTimes"></el-option>
                                    </el-select>
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item prop="stockExperiencesYears" class="margin-bottom-30">
                                    <el-select v-model="regulatoryInfo.stockExperiencesYears" placeholder="请选择交易年数">
                                        <el-option :label="item" :value="key" :key="key"
                                                   v-for="(item, key) in tradeYears"></el-option>
                                    </el-select>
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item prop="stockExperiencesKnowledgeLevel" class="margin-bottom-30">
                                    <el-select v-model="regulatoryInfo.stockExperiencesKnowledgeLevel"
                                               placeholder="请选择知识水平">
                                        <el-option :label="item" :value="key" :key="key"
                                                   v-for="(item, key) in knowledgeLevel"></el-option>
                                    </el-select>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row><el-checkbox v-model="openOptionTrade">期权</el-checkbox></el-row>
                        ...
                        <el-row><el-checkbox v-model="openFeaturesTrade">期货</el-checkbox></el-row>
                        <el-row v-if="openFeaturesTrade">
                            <el-col :span="8">
                                <el-form-item prop="featuresExperiencesTimes" class="margin-bottom-30">
                                    <el-select v-model="regulatoryInfo.featuresExperiencesTimes" placeholder="请选择每年交易次数">
                                        <el-option :label="item" :value="key" :key="key"
                                                   v-for="(item, key) in tradeTimes"></el-option>
                                    </el-select>
                                </el-form-item>
    ...
    data() {
      ...
      const validateNetAsset = (rule, value, callback) => {
        ...
        if (value == 10) {
          ...
          if (value < parseInt(this.regulatoryInfo.netCurrentAsset)) {
      ...
      const validateTotalAsset = (rule, value, callback) => {
        ...
        } else if (value < parseInt(this.regulatoryInfo.netCurrentAsset)) {
