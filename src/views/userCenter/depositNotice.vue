<template>
  <div class="depositNotice">
    ...
    <div class="item">
      <div class="label"><span>*</span>1.请选择您的币种</div>
      <div class="radio-wrap">
        <el-radio v-model="radio" label="1">港币</el-radio>
      </div>
      <div class>
        <el-radio v-model="radio" label="2">美元</el-radio>
      </div>
    </div>
    <div class="item mar0">
      <div class="label"><span>*</span>2.详细通讯地址：</div>
    ...
    <div class="item mar0">
      <div class="label"><span>*</span>3.上传凭证，用于银行对账以加快到账速度（照片文件不能超过10M)：</div>
